        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxCertificateReference = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ReliefProjects_AspNetUsers_CreatedBy",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectUpdates_AspNetUsers_EmployeeId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ReliefProjects_CreatedBy",
                table: "ReliefProjects",
                column: "CreatedBy");

            migrationBuilder.CreateIndex(
                name: "IX_ReliefProjects_Location",
                table: "ReliefProjects",
                column: "Location");

            migrationBuilder.CreateIndex(
                name: "IX_ReliefProjects_StartDate",
                table: "ReliefProjects",
                column: "StartDate");

            migrationBuilder.CreateIndex(
                name: "IX_ReliefProjects_Status",
                table: "ReliefProjects",
                column: "Status");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Volunteers_RegistrationDate",
                table: "Volunteers",
